...
if __name__ == "__main__": 
	...
	button1 = Button(gui, text=' 7 ', fg='black', bg='grey', 
					command=lambda: press(7), height=1, width=7) 
	button1.grid(row=2, column=0) 

	button2 = Button(gui, text=' 8 ', fg='black', bg='grey', 
					command=lambda: press(8), height=1, width=7) 
	button2.grid(row=2, column=1) 

	button3 = Button(gui, text=' 9 ', fg='black', bg='grey', 
	...
	button7 = Button(gui, text=' 1 ', fg='black', bg='grey', 
					command=lambda: press(1), height=1, width=7) 
	button7.grid(row=4, column=0) 

	button8 = Button(gui, text=' 2 ', fg='black', bg='grey', 
					command=lambda: press(2), height=1, width=7) 
	button8.grid(row=4, column=1) 

	button9 = Button(gui, text=' 3 ', fg='black', bg='grey', 
